...
<script src="{{ url('js\ajax_popper.min.js') }}" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
<script src="{{ url('js\stackpath_bootstrap.min.js') }}" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
<script src="{{ url('js\jquery.min.js') }}"></script>
<script src="{{ url('js\moment.min.js') }}"></script>
<script src="{{ url('js\fullcalendar.js') }}"></script>
<script type="text/javascript" src="{{ url('js\ajax_jquery.min.js') }}"></script>
